...
# InceptionResNetV2
InceptionResNetV2_base_model = InceptionResNetV2(weights = "imagenet", include_top=False, input_shape=(512, 128,3))

InceptionResNetV2_base_model.summary()

InceptionResNetV2_model = models.Sequential()

InceptionResNetV2_model.add(InceptionResNetV2_base_model)
InceptionResNetV2_model.add(Flatten())
InceptionResNetV2_model.add(Dense(512,
...
InceptionResNetV2_model.add(Dense(512,
                      ...
                      activation='relu'))
InceptionResNetV2_model.add(Dropout(0.5))
InceptionResNetV2_model.add(Dense(6,
                      kernel_initializer=initializers.random_normal(stddev=0.01),
                      bias_initializer=initializers.Zeros(),
                      activation='softmax'))
...
history_InceptionResNetV2 = InceptionResNetV2_model.fit(x_train_image, 
                          y_train_label_cat,
                          verbose=1, 
                          epochs=10,
...
loss_InceptionResNetV2, acc_InceptionResNetV2 = InceptionResNetV2_model.evaluate(x_test_image, 
                           y_test_label_cat, 
                           batch_size=batch_size)


print('\n\nInceptionResNetV2\n\nLoss     : {} \nAccuracy : {}'.format(history_InceptionResNetV2.history['loss'][-1],history_InceptionResNetV2.history['accuracy'][-1]))
print('\n\nInceptionResNetV2\n\nLoss     : {} \nAccuracy : {}'.format(loss_InceptionResNetV2,acc_InceptionResNetV2))

InceptionResNetV2_model.save("CNN_InceptionResNetV2.h5")


# Test data DenseNet201
Y_pred = InceptionResNetV2_model.predict(x_test_image)
...
plt.title('Receiver operating characteristic to multi-class (InceptionResNetV2)')
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('Zoomed Receiver operating characteristic to multi-class (InceptionResNetV2)')
plt.legend(loc="lower right")
plt.show()
